...
* redis configuration:
 ...
 |clusterUrl                |String |  null      |   no   |Sentinel url，multiple nodes use `;` to separate|   
 ...
 |blockWhenExhausted                |boolean    |  true       |   no   |Whether block the connection when resource is exhausted, false will throw exception, ture will block until timeout|       
